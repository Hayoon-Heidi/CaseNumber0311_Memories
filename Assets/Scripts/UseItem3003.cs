...
public class UseItem3003 : MonoBehaviour
{
    [SerializeField]
    ...
    public void useItem3003(string invenItemId, int invenItemPositoin)
    {
    ...
    IEnumerator ItemUseCoroutine(SmallDialogue dialogue)
    {
        ...
        OtherCollider.transform.position = new Vector3(-4.5f, -0.5f, 0.0f);
    }
}
