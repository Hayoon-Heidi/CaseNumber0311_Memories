...
public class UseItem3004 : MonoBehaviour
{
    [SerializeField]
    ...
    public void useItem3004(string invenItemId, int invenItemPositoin)
    {
    ...
    IEnumerator ItemUseCoroutine(SmallDialogue dialogue)
    {
        ...
        OtherCollider.transform.position = new Vector3(6.5f, -2.5f, 0.0f);
        Debug.Log("event position change. " );
    }
}
