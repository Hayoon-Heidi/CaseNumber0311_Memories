...
public class UseItem3005 : MonoBehaviour
{
    [SerializeField]
    ...
    public GameObject delectObject;
    public GameObject delectNoPassing;
    ...
    public void useItem3005(string invenItemId, int invenItemPositoin)
    {
    ...
    IEnumerator ItemUseCoroutine(SmallDialogue dialogue)
    {
        ...
        delectObject.SetActive(false);
        delectNoPassing.SetActive(false);
    }
}
